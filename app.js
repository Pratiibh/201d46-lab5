...
function multiply(a, b) { //eslint-disable-line
    var multiplied = a * b;
    console.log('multipled : ' + multiplied);
    var return_string_two = 'The product of ' + a + ' and ' + b + ' is ' + multiplied + '.';
    console.log(return_string_two);
    return[multiplied, return_string_two];
}
